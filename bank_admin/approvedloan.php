...
<html lang="en">
  <head>
    <title>Dashboard approved loan</title>
    <meta charset="utf-8">
	        	...
	        	<div >
	        		...
	        		<div class="container ftco-animate" style="border: 1px solid grey; border-radius: 5px">
                      ...
                      <?php 
                        ...
                        WHERE loanrequest.customerNo = registercustomer.id AND loanstatus = 'approved' ORDER BY reqid desc";
                      ...
                      <tr>
                          ...
                          <td><?php  $repaymentDate = strtotime($repaymentDate);
                                $repaymentDate = date('d M, Y', $repaymentDate); 
                                echo $repaymentDate; ?></td>
                          
                          <td><?php $totalamount = $amountint + $interestRate;
                                echo $totalamount;
                             ?>     
                          </td>
