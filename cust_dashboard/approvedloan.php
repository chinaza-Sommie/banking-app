                      ...
                      <tr>
                          ...
                          <td>
                            <?php
                                ...
                                $repaymentDate = strtotime($repaymentDate);
                          ...
                          <td class="text-success"><i> APPROVED</i></td>
                          <td>
                            <a href="../Flutterwave-Rave/paymentForm.php?reqID=<?= $loanId; ?>" class="btn btn-success m-1">Pay</a>
                            <!-- <a href="payaction.php?pay=<?=$loanId;?>" class="btn btn-success m-1">Pay</a> -->
                          </td>
                      </tr>
