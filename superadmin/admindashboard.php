          ...
          <div class="mycontainhide" id="storeItems">
            <div >
              <div class="col-md-4 heading-section text-center ftco-animate py-4" >
                <span class="subheading" style="font-size: 20px">investments</span>
            </div>
            </div>
              ...
              <div class="container">
                <div class="row justify-content-center">
                  <div class="col-md-12 heading-section text-center ftco-animate mb-5">
                    <p class="mb-2">Invest in any business and make profit at a high rate. Time is money.</p>
                  </div>
                </div>
                  ...
                  <div class="col-md-3 d-flex align-self-stretch ftco-animate mt-2">
                    <div class="media block-6 services d-block text-center px-5" style="border:1px solid grey; border-radius:5px;">
                      ...
                      <div class="media-body py-md-4">
                        <p style="color: black"><b>Invest in Agriculture </b></p>
